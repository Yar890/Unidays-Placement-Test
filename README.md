...
The first step I did was note down all the requirements that the program needs to meet. Next, I look through the requirements and start thinking about what classes and methods I will need and how I will store variables, such as what data type to use and if I should use an array, list or dictionary. I also try to look for some similarties between the requirements, which can help with identifing ways of improving the efficiency of the program. I then created a new project and add it to this repository, while making sure that I commit after each change. I then start going through the requirements list and working on one requirement at a time. While programming, if I identify another potential way of imporving the program, I send a new commit and start working the new idea I have to improve the program. In the event that the code starts to run into issues due to a major change, I can always revert to a previous commit.
